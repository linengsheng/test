<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Edit.aspx.cs" Inherits="WebSystem.Admin.ColumnManage.Edit" %>
...
<body>
    ...
    <div style="margin:10px;min-width:800px;">
        ...
        <tr style="line-height:30px">
            ...
            <td class="tdR">
                <asp:Label runat="server" ID="lbparentname"></asp:Label>
            </td>
        </tr>
        <tr style="height:30px" >
            ...
            <td class="tdR">
                <asp:TextBox ID="txtcolumnname" runat="server" MaxLength="20" Width="300px" CssClass="editBox" ></asp:TextBox>
                <asp:RequiredFieldValidator ID="rfv5" runat="server" ControlToValidate="txtcolumnname" Display="Dynamic" ErrorMessage="*" ValidationGroup="g1" SetFocusOnError="True"></asp:RequiredFieldValidator>
            </td>            
        </tr> 
        <tr style="height:30px">
            <td class="tdH">
            ...
            <td class="tdR">
                <asp:TextBox ID="txtcolumnurl" runat="server" MaxLength="200" Width="300px" CssClass="editBox" ></asp:TextBox>
                <asp:Label runat="server" ID="lbcolumnid"></asp:Label>
            </td>            
        </tr>
        <tr style="line-height:30px">
            <td class="tdH">

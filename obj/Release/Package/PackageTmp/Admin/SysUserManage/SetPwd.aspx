<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SetPwd.aspx.cs" Inherits="WebSystem.Admin.SysUserManage.SetPwd" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head runat="server">
    <title>设置系统用户密码</title>
...
<body>
    ...
    <div style="margin:10px;min-width:800px;">
        ...
        <tr style="height:30px" >
            ...
            <td class="tdR">
                <asp:Label runat="server" ID="lbrealname"></asp:Label>
            </td>            
        </tr>
        <tr style="height:30px" >
            <td class="tdH">

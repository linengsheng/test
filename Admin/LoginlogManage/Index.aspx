<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Index.aspx.cs" Inherits="WebSystem.Admin.LoginlogManage.Index" %>
...
<body>
    ...
    <div style="margin:10px;">
        ...
        登录时间：<asp:TextBox ID="txtBeginDate" runat="server" Width="120px" MaxLength="20" onfocus="new WdatePicker(this,'%Y年%M月%D日',false)" CssClass="searchBox"></asp:TextBox>-
    ...
    <div style="margin:10px;" align="center">
        <asp:GridView ID="gvData" runat="server" AutoGenerateColumns="false" Width="100%" CssClass="table" OnRowDataBound="gvData_RowDataBound" DataKeyNames="sysuserloginlog_id">
            <Columns>
                ...
                <asp:BoundField DataField="login_ip" HeaderText="登录IP" />
                <asp:BoundField DataField="login_time" HeaderText="登录时间" DataFormatString="{0:yyyy-MM-dd HH:mm:ss}" ItemStyle-Width="180px" />
                <asp:TemplateField HeaderText="操作" >
                    <ItemTemplate>
                        <asp:LinkButton ID="btnDel" runat="server" OnCommand="btnDel_Command" CommandArgument='<%# Eval("sysuserloginlog_id")%>' OnClientClick="return confirm('删除数据不可恢复，您确认要删除吗？');">&nbsp;删除&nbsp;</asp:LinkButton>
                    </ItemTemplate>
    ...
    <asp:GridView ID="gvOut" runat="server" AutoGenerateColumns="false" >
        <Columns>
            ...
            <asp:BoundField DataField="realname" HeaderText="真实姓名" />
            <asp:BoundField DataField="login_ip" HeaderText="登录IP" />
            <asp:BoundField DataField="login_time" HeaderText="登录时间" DataFormatString="{0:yyyy-MM-dd HH:mm:ss}" />
        </Columns>
    </asp:GridView>
    </form>
</body>
